...
{
$id=$_POST['id'];
$delete = "DELETE FROM sementics WHERE id='$id'";
mysql_query( $delete);
}
?>
...
<?PHP
					$per_page = 10; 
					$select_table = "select * from sementics";
...
<TD><?php echo $row['skeyword']; ?></TD>
<TD><?php echo $row['count']; ?></TD>
<TD>
<a href="#" class="ABCD" id="<?php echo $row['id']; ?>">[ Delete ]</a>
</TD>
</TR>
<?php
}
