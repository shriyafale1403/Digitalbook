    ...
    <div class="template-page-wrapper">
      <form class="form-horizontal templatemo-signin-form" role="form" action="Main.php" method="post">
        <div class="form-group">
          <div class="col-md-12">
            <label for="username" class="col-sm-2 control-label"> <font style="font-size:13px" color="#0000" face="Arial">Email</font></label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
          <div class="col-md-12">
            <label for="password" class="col-sm-2 control-label"><font style="font-size:13px" color="#000" face="Arial">Password</font></label>
            <div class="col-sm-10">
